...
class NOSBackend(Protocol):
    ...
    def provision_evpn_instance(self, node: NodeInfo, service_name: str, service_id: int, vni: int, evi: int, route_distinguisher: str, export_rt: str, import_rt: str, dry_run: bool, interface_name: str = "", vlan_id: int = 0) -> str: ...
